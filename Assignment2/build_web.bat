...
REM --- GLM header-only dependency -------------------------------------------
SET "GLM_DIR=build_desktop\_deps\glm-src"
IF NOT EXIST "%GLM_DIR%\glm\glm.hpp" (
    SET "GLM_DIR=web\.deps\glm"
    IF NOT EXIST "web\.deps\glm\glm\glm.hpp" (
        echo Fetching GLM 1.0.1...
        git clone --depth 1 --branch 1.0.1 https://github.com/g-truc/glm.git "web\.deps\glm"
